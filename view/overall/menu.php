    ...
    <div class="header-area">
      ...
      <body id="idnvar" >
        ...
        <nav class="navbar" style="height:130px;">
          <a href="?mwc=home"><img src="assets/img/2mwcall.png"  style="width:200px; height:100px; margin-left:10px; margin-top: 5px; margin-bottom:10px; float:left;" ></a>
          ...
          <?php if ($_SESSION['IdUsuario'] =='') { echo 'display:none;';} ?>">
            ...
            <li  class="scroll active" style="margin-left:50px"><a href="#home">Inicio <span class="sr-only">(current)</span></a></li>
        ...
        <div id="side-menu" class="side-nav" style="text-align: left;">
          ...
          <?php  $_SESSION["IdPermiso"]=0;
          if ($_SESSION["IdPermiso"]<> 0)  {?>
            <?php if ($_SESSION["IdPermiso"]==3) {?>
