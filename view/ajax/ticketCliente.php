...
<div class="" style='  <?php if ($sesion==$datos["IdUser"]) {echo "display:none;";}?>'>
  <div class="col-lg-4 col-xs-4">
   <div class="form-group">
    ...
    <select class="form-control" <?php if ($datos['Estatus']==3) { echo 'disabled="true"'; }?> id="txtPrioridad" name="txtPrioridad">
     ...
     <option value="1" <?php if($datos["Prioridad"] == "1") { ?>selected="selected" <?php  } ?>> Prioridad 1 </option>
     <option value="2" <?php if($datos["Prioridad"] == "2") { ?>selected="selected" <?php  } ?>> Prioridad 2 </option>
     <option value="3" <?php if($datos["Prioridad"] == "3") { ?>selected="selected" <?php  } ?>> Prioridad 3 </option>
    </select>
   </div>
  </div>
